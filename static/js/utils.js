...
PTL.utils = (function ($) {
  ...
  return {
    ...
    cleanWhitespace: function(s) {
      return s.replace(whitespaceRE, ' ');
    },
    ...
    fancyEscape: function (text) {
      ...
      function replace(match) {
          ...
          if (replaced === undefined) {
            ...
            var replaced_obj = $('<span class="highlight-html tag-number" contenteditable="false" bounce="south"></span>');
            replaced_obj.text(tag_index++);
            replaced_obj.attr('title', $('<div />').text(match).html());
            replaced = replaced_obj.get(0).outerHTML;
          }
